...
class StableDiffusionXLPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        logger.info(f"{time.time_ns()}: ###################### Prompt encoder started")
        ...
        logger.info(f"{time.time_ns()}: ###################### Prompt encoder took {(time.time_ns()-start_t)/1000000.0}ms")
        ...
        if not output_type == "latent":
            ...
            logger.info(f"{time.time_ns()}: ###################### VAE decoder completed in {(time.time_ns()-start_t)/1000000.0}ms")
